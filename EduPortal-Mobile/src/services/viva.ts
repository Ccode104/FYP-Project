...
export async function generateVivaQuestions(data: {
  ...
  return apiFetch('/viva/generate-questions', {
    method: 'POST',
    body: data
  })
}
...
export async function updateVivaParticipantStatus(data: {
  ...
  return apiFetch('/viva/participant/status', {
    method: 'POST',
    body: data
  })
}