...
async function applyGitHubMigrations() {
  try {
    ...
    const migrationSQL1 = fs.readFileSync('./migrations/migrations/add_github_integration_fields.sql', 'utf8');
    ...
    const migrationSQL2 = fs.readFileSync('./migrations/migrations/add_github_repository_submission_fields.sql', 'utf8');
